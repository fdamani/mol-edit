...
input_dir="/tigress/fdamani/mol-edit-output/onmt-logp04/preds/recurse_limit/${seed_type}/${model_type}/${rank_type}/cands/seeds"
output_dir="/tigress/fdamani/mol-edit-output/onmt-logp04/preds/recurse_limit/${seed_type}/${model_type}/${rank_type}/cands"
