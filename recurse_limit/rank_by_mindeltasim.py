'''
rank compounds by *dis*similarity with previous step
this is designed for highly explorative traces (max steps between steps)
...
return cand with min sim with prev iter seed
'''
